...
-- URL: https://atlas-demo.ohdsi.org/#/cohortdefinition/1779685
...
( 
  select concept_id from CONCEPT where concept_id in (262,9203,9201)
...
( 
  select concept_id from CONCEPT where concept_id in (4329847)
UNION  select c.concept_id
  from CONCEPT c
  join CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
LEFT JOIN
(
  select concept_id from CONCEPT where concept_id in (314666)
UNION  select c.concept_id
  from CONCEPT c
  join CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from CONCEPT where concept_id in (4048809,321042,442289,4317150,4132309)
UNION  select c.concept_id
  from CONCEPT c
  join CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
LEFT JOIN
(
  select concept_id from CONCEPT where concept_id in (437894)
UNION  select c.concept_id
  from CONCEPT c
  join CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
LEFT JOIN
(
  select concept_id from CONCEPT where concept_id in (315295)
UNION  select c.concept_id
  from CONCEPT c
  join CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from CONCEPT where concept_id in (376713,439847,43530674,43530727,42535425,4148906,432923)
